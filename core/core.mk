...
ProjectPath            := "D:\gits\opengl_core\core"
...
IncludePath            := $(IncludeSwitch)E:/tdmgcclib/include $(IncludeSwitch)E:/tdmgcclib/include/freetype $(IncludeSwitch)F:/opengl/wxWidgets-3.0.2/include $(IncludeSwitch)F:/opengl/wxWidgets-3.0.2  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)./include 
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
...
$(IntermediateDirectory)/src_gl3w.c$(ObjectSuffix): src/gl3w.c $(IntermediateDirectory)/src_gl3w.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/gits/opengl_core/core/src/gl3w.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_gl3w.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_ViewOGL.cpp$(ObjectSuffix): core/ViewOGL.cpp $(IntermediateDirectory)/core_ViewOGL.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/gits/opengl_core/core/core/ViewOGL.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_ViewOGL.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_ShaderOGL.cpp$(ObjectSuffix): core/ShaderOGL.cpp $(IntermediateDirectory)/core_ShaderOGL.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/gits/opengl_core/core/core/ShaderOGL.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_ShaderOGL.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/core_PxBase.cpp$(ObjectSuffix): core/PxBase.cpp $(IntermediateDirectory)/core_PxBase.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/gits/opengl_core/core/core/PxBase.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/core_PxBase.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/cmn_PxMem.cpp$(ObjectSuffix): cmn/PxMem.cpp $(IntermediateDirectory)/cmn_PxMem.cpp$(DependSuffix)
...
$(IntermediateDirectory)/cmn_PxMem.cpp$(DependSuffix): cmn/PxMem.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/cmn_PxMem.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/cmn_PxMem.cpp$(DependSuffix) -MM "cmn/PxMem.cpp"

$(IntermediateDirectory)/cmn_PxMem.cpp$(PreprocessSuffix): cmn/PxMem.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/cmn_PxMem.cpp$(PreprocessSuffix) "cmn/PxMem.cpp"

$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/gits/opengl_core/core/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Application.cpp$(ObjectSuffix): Application.cpp $(IntermediateDirectory)/Application.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/gits/opengl_core/core/Application.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Application.cpp$(ObjectSuffix) $(IncludePath)
